...
export const selectNodeDataArrayRedux = (state) =>
  state.custom_tree.nodeDataArrayRedux;
export const selectLinkDataArrayRedux = (state) =>
  state.custom_tree.linkDataArrayRedux;
