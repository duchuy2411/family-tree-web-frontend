...
export default function CalendarPage() {
  ...
  const handleChangeForm = (e, label) => {
    switch(label) {
      case 'notes': { setForm({...form, notes: e.target.value}); break; }
      case 'start': { setForm({...form, startDate: e.target.value}); break; }
      case 'end': { setForm({...form, endDate: e.target.value}); break; }
      case 'loop': { setForm({...form, loop: e.target.value}); break; }
      default: { break; }
    }
  }
