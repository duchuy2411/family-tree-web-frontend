  ...
  getRepeat (data, thisTime) {
    ...
    data.forEach(ele => {
      ...
      switch (getRepeat) {
        ...
        case 2: {
          const newDate = new Date(moment(thisTime).year(), moment(thisTime).month(), moment(cur).date());
          newArr.push(newDate);
          break;
        }
        case 3: {
          const newDate = new Date(moment(thisTime).year(), moment(cur).month(), moment(cur).date());
          newArr.push(newDate);
          break;
        }
      }
