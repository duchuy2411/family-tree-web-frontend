...
import { HIDE_VIEW_IMAGE, NEXT_IMAGE, PREV_IMAGE, selectViewImage } from '../calendarSlice';
...
const ShowImage = (props) => {
  ...
  const hide = () => { dispatch(HIDE_VIEW_IMAGE()) };
  return (
    <div
      style={{
  ...
  return (
    <Grid container xs={12} className="container-view-img" onKeyPress={handlePress}>
      ...
      <Grid item xs={2} className="child-container">
        <div className="fas fa-chevron-left navi-view-img"
          onClick={clickBack}
        />
      </Grid>
      ...
      <Grid item xs={2} className="child-container">
        <div className="fas fa-chevron-right navi-view-img"
          onClick={clickNext}
        />
        <div
          className="fas fa-times-circle btn-exit-view"
          onClick={hide}>
        </div>
      </Grid>
    </Grid>
